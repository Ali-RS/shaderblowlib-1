package com.jme3.shaderblow.filter.basicssao;
...
//    protected void postQueue(final RenderManager renderManager, final ViewPort viewPort) {
    ...
    protected void initFilter(final AssetManager manager, final RenderManager renderManager, final ViewPort vp,
        ...
        // ssao Pass
        this.ssaoMat = new Material(manager, "MatDefs/Filters/BasicSSAO/BasicSSAO.j3md");
        ...
        this.material = new Material(manager, "MatDefs/Filters/BasicSSAO/BasicSSAOBlur.j3md");

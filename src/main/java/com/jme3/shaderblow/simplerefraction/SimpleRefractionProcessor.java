 ...
 */
package com.jme3.shaderblow.simplerefraction;
...
public class SimpleRefractionProcessor implements SceneProcessor {
    ...
    public SimpleRefractionProcessor(final AssetManager manager) {
        ...
        this.material = new Material(manager, "MatDefs/SimpleRefraction/SimpleRefraction.j3md");
...
//        this.rm.setForcedTechnique(null);    
    ...
    protected void loadTextures(final AssetManager manager) {
        this.normalTexture = (Texture2D) manager.loadTexture("Textures/Refraction/water_normalmap.png");
        ...
        this.dudvTexture = (Texture2D) manager.loadTexture("Textures/Refraction/dudv_map.png");

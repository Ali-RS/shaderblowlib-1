package com.jme3.shaderblow.test.simplespriteparticle;
...
public class TestSimpleSpriteParticle extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        final Material mat = new Material(this.assetManager,
                "MatDefs/SimpleSpriteParticle/SimpleSpriteParticle.j3md");
        mat.setTexture("Texture", this.assetManager.loadTexture("Textures/matcaps/Gold.jpg"));

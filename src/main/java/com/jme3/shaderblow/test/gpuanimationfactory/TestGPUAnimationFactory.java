package com.jme3.shaderblow.test.gpuanimationfactory;
...
public class TestGPUAnimationFactory extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        final Material mat_1D = new Material(this.assetManager,
                "MatDefs/GPUAnimationFactory/GPUAnimationFactory.j3md");

//// Standard uniforms for lighting
//mat_1D.setBoolean("SteepParallax", true);
        mat_1D.setFloat("Scale", 3.0f);

        final TextureKey tkDif = new TextureKey("Textures/Terrain_Textures/pattern_69/pattern_69_diffus.png", false);
        ...
        final TextureKey tkNor = new TextureKey("Textures/Terrain_Textures/pattern_69/pattern_69_normal.png", false);

package com.jme3.shaderblow.test.texturebombing;
...
public class TestTextureBombing extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        Geometry child = (Geometry) ((Node) clone).getChild("Material");
        ...
        Geometry child1 = (Geometry) ((Node) clone1).getChild("Material");

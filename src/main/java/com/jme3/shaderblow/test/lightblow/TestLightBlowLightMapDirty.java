...
public class TestLightBlowLightMapDirty extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        final Spatial char_boy = this.assetManager.loadModel("Models/LightBlow/lightmap/lightmap.mesh.xml");
        final Material mat = this.assetManager.loadMaterial("Materials/LightBlow/lightmap/lightmap.j3m");
        char_boy.setMaterial(mat);
        TangentBinormalGenerator.generate(char_boy);
        this.rootNode.attachChild(char_boy);

        final Spatial char_boy2 = this.assetManager.loadModel("Models/LightBlow/lightmap/lightmap.mesh.xml");
//        final Material mat2 = this.assetManager.loadMaterial("Materials/LightBlow/lightmap/lightmap_dirty.j3m");

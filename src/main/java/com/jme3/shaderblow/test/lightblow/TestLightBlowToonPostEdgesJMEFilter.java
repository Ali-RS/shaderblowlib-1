...
public class TestLightBlowToonPostEdgesJMEFilter extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        final Spatial toon = this.assetManager.loadModel("Models/ToonBlow/toon.obj");
        final Material mat = this.assetManager.loadMaterial("Materials/LightBlow/Toon_System/Toon_Base.j3m");
        toon.setMaterial(mat);
        TangentBinormalGenerator.generate(toon);
        this.rootNode.attachChild(toon);

        final Spatial toon2 = this.assetManager.loadModel("Models/ToonBlow/toon.obj");
        final Material mat2 = this.assetManager
                .loadMaterial("Materials/LightBlow/Toon_System/Toon_Base_Specular.j3m");

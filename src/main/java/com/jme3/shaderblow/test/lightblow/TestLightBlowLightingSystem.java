...
public class TestLightBlowLightingSystem extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        final Material mat = this.assetManager
                .loadMaterial("Materials/LightBlow/Lighting_System/LightBlow_Base.j3m");
        ...
        final Material mat2 = this.assetManager
                .loadMaterial("Materials/LightBlow/Lighting_System/LightBlow_HemiLighting_1.j3m");
        ...
        final Material mat3 = this.assetManager
                .loadMaterial("Materials/LightBlow/Lighting_System/LightBlow_HemiLighting_2.j3m");
        ...
        final Material mat4 = this.assetManager
                .loadMaterial("Materials/LightBlow/Lighting_System/LightBlow_Base_Specular.j3m");
        ...
        final Material mat5 = this.assetManager
                .loadMaterial("Materials/LightBlow/Lighting_System/LightBlow_Linear.j3m");

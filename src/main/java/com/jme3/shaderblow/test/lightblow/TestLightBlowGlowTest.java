...
public class TestLightBlowGlowTest extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        final Spatial char_boy = this.assetManager.loadModel("Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat = this.assetManager.loadMaterial("Materials/LightBlow/Shading_System/LightBlow_ibl.j3m");
        char_boy.setMaterial(mat);
        TangentBinormalGenerator.generate(char_boy);
        this.rootNode.attachChild(char_boy);

        final Spatial char_boy2 = this.assetManager.loadModel("Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat2 = this.assetManager
                .loadMaterial("Materials/LightBlow/Shading_System/LightBlow_reflection.j3m");
        ...
        final Spatial char_boy2_2 = this.assetManager.loadModel("Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat2_2 = this.assetManager
                .loadMaterial("Materials/LightBlow/Shading_System/LightBlow_reflection_additive.j3m");
        ...
        final Spatial char_boy3 = this.assetManager.loadModel("Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat3 = this.assetManager
                .loadMaterial("Materials/LightBlow/Shading_System/LightBlow_ref_a_nor.j3m");
        ...
        final Spatial char_boy4 = this.assetManager.loadModel("Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat4 = this.assetManager
                .loadMaterial("Materials/LightBlow/Shading_System/LightBlow_minnaert.j3m");
        ...
        final Spatial char_boy5 = this.assetManager.loadModel("Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat5 = this.assetManager
                .loadMaterial("Materials/LightBlow/Shading_System/LightBlow_rim.j3m");
        ...
        final Spatial char_boy6 = this.assetManager.loadModel("Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat6 = this.assetManager
                .loadMaterial("Materials/LightBlow/Shading_System/LightBlow_rim_2.j3m");
